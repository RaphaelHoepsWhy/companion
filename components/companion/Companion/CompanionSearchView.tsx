    ...
    <div className="relative size-full overflow-hidden">
      <div className="flex h-full w-full flex-col gap-6 p-6">
        <div className="flex items-center gap-3">
          ...
          <div className="flex h-12 flex-1 items-center rounded-full bg-neutral-400/60 px-5">
            <input
              type="text"
              autoFocus
          ...
          <button
            ...
            onClick={onClose}
            aria-label="Close"
            className="flex shrink-0 cursor-pointer items-center justify-center rounded-full bg-neutral-500 p-2 transition-colors hover:bg-neutral-600"
          >
